   ...
   private static void xmlList(XMLTree feed,String file, SimpleWriter output) {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        if(getChildElement(channel,"title")!=-1) {
	        if(channel.child(getChildElement(channel,"title")).numberOfChildren()>0&&!channel.child(getChildElement(channel,"title")).child(0).label().equals("")) {
        ...
        if(!channel.child(getChildElement(channel,"link")).child(0).label().equals("")) {
        	if(getChildElement(channel,"title")!=-1) {
        		if(channel.child(getChildElement(channel,"title")).numberOfChildren()>0&&!channel.child(getChildElement(channel,"title")).child(0).label().equals("")) {
        			...
        			out.println("<h1><a href="+'"'+channel.child(getChildElement(channel,"link")).child(0).label()+'"'+">Empty title</a></h1>");
        		}
        	}
        	else {
        		out.println("<h1><a href="+'"'+channel.child(getChildElement(channel,"link")).child(0).label()+'"'+">Empty title</a></h1>");
        ...
        out.print("<p>");
        if(channel.child(getChildElement(channel,"description")).numberOfChildren()>0 && !channel.child(getChildElement(channel,"description")).child(0).equals("")) {
