...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        JPanel mainButton = new JPanel(new GridLayout(MAIN_BUTTON_PANEL_GRID_ROWS,MAIN_BUTTON_PANEL_GRID_COLUMNS));

        /*
         * Add the buttons to the main button panel, from left to right and top
         * to bottom
         */
        mainButton.add(this.bDigits[7]);
        mainButton.add(this.bDigits[8]);
        mainButton.add(this.bDigits[9]);
        mainButton.add(this.bAdd);
        mainButton.add(this.bDigits[4]);
        mainButton.add(this.bDigits[5]);
        mainButton.add(this.bDigits[6]);
        mainButton.add(this.bSubtract);
        mainButton.add(this.bDigits[1]);
        mainButton.add(this.bDigits[2]);
        mainButton.add(this.bDigits[3]);
        mainButton.add(this.bMultiply);
        mainButton.add(this.bDigits[0]);
        mainButton.add(this.bPower);
        mainButton.add(this.bRoot);
        mainButton.add(this.bDivide);
        /*
         * Create side button panel
         */
        JPanel sideButton = new JPanel(new GridLayout(SIDE_BUTTON_PANEL_GRID_ROWS,SIDE_BUTTON_PANEL_GRID_COLUMNS));
        /*
         ...
         */
        JPanel combineButton = new JPanel(new FlowLayout());

        /*
         * Add the other two button panels to the combined button panel
         */
        combineButton.add(mainButton);
        combineButton.add(sideButton);
